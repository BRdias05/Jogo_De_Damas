...
public class PainelCriaPartida extends JFrame implements ActionListener{
    ...
    public PainelCriaPartida(Principal Pprincipal,Jogo jogo) {
        iniciar();
